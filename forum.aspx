<%@ Page ValidateRequest="false" EnableViewState="false" EnableEventValidation="false"
    Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="PageForum" Title="Untitled Page" EnableViewStateMac="false" CodeFile="forum.aspx.vb" %>
...
<td>
<input id="ImgTitle" ClientIDMode="Static" type="text" maxlength="40" size="50" runat="server" spellcheck="true" />
</td>
</tr>
<tr>
<td>
...
<td>
<textarea id="ImgDescription" ClientIDMode="Static" rows="4" cols="40" runat="server" name="S1" spellcheck="true"></textarea>
</td>
</tr>
<tr>
<td colspan="2">
