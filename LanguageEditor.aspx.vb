...
Partial Class LanguageEditor
    ...
    If Plugin Is Nothing Then Plugin = New PluginManager.Plugin(AddressOf Description, Authentication.User.RoleType.WebMaster, True, False, PluginManager.Plugin.Characteristics.CorePlugin)
		Return Plugin
	End Function
	Shared Sub New()
		Initialize()
    ...
    Dim Source As LanguageManager.Language
    If Setting.Language <> LanguageManager.Language.English Then
      Source = LanguageManager.Language.English
      LCode = 80 'English
    Else
      Source = LanguageManager.Language.Italian
      LCode = 81 'Italian
    End If
    ...
    Dim SourceDictionary As Collections.Generic.Dictionary(Of Integer, String) = LanguageManager.PhraseBooks(Source)
    Dim Dictionary As Collections.Generic.Dictionary(Of Integer, String) = LanguageManager.PhraseBooks(Setting.Language)
  ...
  End Sub
	...
	Class SortAlphapetic
      ...
      Return StrComp(Phrase(Language, CInt(Id1)), Phrase(Language, CInt(Id2)), CompareMethod.Text)
