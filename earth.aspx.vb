...
Partial Class earth
  ...
  Public MasterPage As Components.MasterPageEnhanced
    ...
    If Not String.IsNullOrEmpty(Me.Country.Text) Then
    ...
    If AllCity IsNot Nothing Then
      ...
      Else
        ...
        For Each City In AllCity
          ...
          LinkCity.Text = HttpUtility.HtmlEncode(City.Name & " (" & CountryName(City) & " - " & RegionName(City) & ")")
          LinkCity.NavigateUrl = Href(Setting.Name, False, "earth.aspx", EarthManager.QueryStringParameters(City.Name, Tables.CountryName(City), City.Latitude, City.Longitude))
    ...
    If Not String.IsNullOrEmpty(Latitude.Text) AndAlso Not String.IsNullOrEmpty(Longitude.Text) Then
  ...
  End Sub
    ...
    AddLiteral(CType(PlaceHolderMap, Control), Code)
  End Sub
