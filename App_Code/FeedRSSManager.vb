...
Namespace WebApplication
    ...
    Public Sub ReadFeed(ByRef Records As Collections.Generic.List(Of Notice), ByVal NewsRequire As NewsRequire, Optional ByVal UserAgent As String = "Mozilla/5.0", Optional ByVal ResolveRedirect As Boolean = False, Optional ByRef GetTitle As String = Nothing, Optional ByRef GetDescription As String = Nothing)
      Try
        Dim WebRequest As System.Net.HttpWebRequest
        WebRequest = CType(System.Net.HttpWebRequest.Create(NewsRequire.XmlHref), System.Net.HttpWebRequest)
          ...
          For N2 As Integer = 0 To Node.ChildNodes.Count - 1
            ...
            For N3 As Integer = 0 To Node2.ChildNodes.Count - 1
              ...
              Select Case Node3.Name
                Case "title"
                  GetTitle = Node3.InnerText
                Case "description"
                  GetDescription = Node3.InnerText
              End Select
                    ...
                    Select Case Node4.Name.ToLower()
                      ...
                      Case "enclosure"
                        ...
                        Try
                          ...
                          ElseIf Node4.Attributes("type").Value.ToLower().StartsWith("video/") Then
                            Notice.Video = Node4.Attributes("url").Value
                          End If
                        Catch ex As Exception
                        End Try
                    End Select
                  ...
                  If NewsRequire.AddAllRecords = True OrElse ValidForCriteria(Notice, NewsRequire.KeyWords, NewsRequire.NotKeyWords) Then
                    ...
                    If Records IsNot Nothing Then
                      ...
                      For Each ArchivedRSS As Notice In Records
                        If (ArchivedRSS.Title = Notice.Title AndAlso ArchivedRSS.Description = Notice.Description) OrElse ArchivedRSS.Link = Notice.Link Then
                          Duplicate = True
                          Exit For
                        End If
                      Next
        ...
        SortNews(Records)
      Catch ex As Exception
        Extension.Log("ERROR RSS source", 100, NewsRequire.XmlHref, ex.Message)
