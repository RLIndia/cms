...
Namespace WebApplication
    ...
    End Function
      ...
      Dim ReturnError As SmsError = SmsError.None
      If CBool(SmsAvailable()) Then
        Select Case WebServicesEnabledSendSMS
          Case Config.WebServicesSendSms.WwwWebservicexCom
            If PhoneNumber.Chars(0) = "+"c Then
              PhoneNumber = Mid(PhoneNumber, 2)
            End If
            Dim Services As New com.webservicex.www.SendSMSWorld
            Dim CountryCode As String = Extension.Left(PhoneNumber, PhoneNumber.Length - 10)
            PhoneNumber = Extension.Right(PhoneNumber, 10)
