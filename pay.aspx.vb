...
Partial Class pay
  ...
  Private MasterPage As Components.MasterPageEnhanced
    ...
    If Not String.IsNullOrEmpty(Request.Form("item_number")) Then
    ...
    If Not String.IsNullOrEmpty(ServicePaid) Then
    ...
    Else
      ...
      Components.AddPageArchived(DescriptionModalityOfPayment, MasterPage, 0, 1, HttpContext.Current, CurrentDomainConfiguration, Setting, Nothing, False, True, False)
      DescriptionModalityOfPayment.Controls.Add(New LiteralControl("<form>"))
    End If
	End Sub
    ...
    If String.IsNullOrEmpty(ModalityOfPayment.Text) Then
      MasterPage.AddMessage(Setting, 3206)
      Exit Sub
    End If

		Dim FlagKey As String = "Payment" & ServicePaid.ToString & Request("id")
    If Not Session(FlagKey) Is Nothing AndAlso IsLocal() = False Then
