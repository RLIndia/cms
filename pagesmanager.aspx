<%@ Page Language="VB" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableViewState="false" Inherits="pagesmanager" EnableViewStateMac="false" CodeFile="pagesmanager.aspx.vb" %>
					...
					<table id="Table2">
						...
						<tr>
							<td colspan="3">
								...
								<asp:TextBox ID="TitleItem" runat="server" Width="264px"></asp:TextBox>
							</td>
						</tr>
						<tr>
							<td colspan="3">
