  ...
  Private CurrentUser As User
    ...
    CurrentUser = Authentication.CurrentUser(Session)
      ...
      If PhotoAlbum IsNot Nothing Then
        ...
        AddPhotos(ListPhotos, PhotoAlbum, Setting.Language, True, Request.QueryString("author"))
        If Not String.IsNullOrEmpty(Request.QueryString("AddAlbum")) Then
          Dim AddAlbum As PhotoAlbum = CType(PhotoManager.PhotoAlbum.Load.GetItem(Request.QueryString("AddAlbum")), PhotoManager.PhotoAlbum)
          AddPhotos(ListPhotos, AddAlbum, Setting.Language, True, Request.QueryString("author"))
        End If
    ...
    Else
      ...
      Dim ObjAlbum As PhotoAlbum = CType(PhotoManager.PhotoAlbum.Load.GetItem(Album), PhotoAlbum)
