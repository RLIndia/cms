...
Partial Class contact
    ...
    If Not Page.IsPostBack Then
      ...
      If CurrentUser.GeneralRole <> Authentication.User.RoleType.Visitors Then
        ...
        If Not String.IsNullOrEmpty(FromName.Text) AndAlso Not String.IsNullOrEmpty(CurrentUser.LastName) Then
          FromName.Text &= " "
        End If
  ...
  Sub AddPhoneContact()
    ...
    For Each Service As Config.Configuration.ContactsConfiguration.Service In [Enum].GetValues(GetType(Config.Configuration.ContactsConfiguration.Service))
      If Service <> Config.Configuration.ContactsConfiguration.Service.General Then
        Dim PhoneContact1 As Config.Configuration.ContactsConfiguration.PhoneContact = Setting.PhoneContact(Service)
      ...
      End If
    Next
    If CBool(Row.Controls.Count) Then
  ...
  Sub AddLogo(ByVal Skin As Config.Skin)
    If Not Skin Is Nothing Then
      ...
      S1.Controls.Add(Components.Icon(IconType.Help, Skin))
      S2.Controls.Add(Components.Icon(IconType.TechSupport, Skin))
  ...
  Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
    ...
    If Page.IsValid Then
      ...
      Else
        ...
        Table.Rows(2).Cells(1).Controls.Add(Components.Literal(CurrentUser(Session).Username))
        'IP
        ...
        End If
        SendEmail(MailSubject.Text, ControlToText(Ctrl), Destination, True, True, True, Config.Configuration.EmailSender.Supervisor, FromEmail.Text)
